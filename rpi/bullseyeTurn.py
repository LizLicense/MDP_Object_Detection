...
def move_backwardLeft(n):
    backwardLeft = bytearray([0x5a,0x0c,0x01,0x01,0xff,0x38,0x00,0x00,0x03,0xe8,0x00,0xff])
...
def move_backwardright():
    backwardRight = bytearray([0x5a,0x0c,0x01,0x01,0xff,0x38,0x00,0x00,0xfc,0x18,0x00,0xff])
